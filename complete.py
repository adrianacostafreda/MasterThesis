...
"""
 ...
 -----------------------Part 4: Estimating Evoked Responses----------------------------------------------------------------
...
"""
 ...
 -----------------------Part 5: Test Files to see which ones are missing----------------------------------------------------------------
...
"""
 ...
 -----------------------Part 6: Time-Frequency Analysis----------------------------------------------------------------
...
# Have to decide how to determine the threshold
mne.preprocessing.corrmap(icas, template=(0, eog_index[0]), show=True, threshold = 0.35)
plt.show()