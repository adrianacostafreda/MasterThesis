...
def compute_and_plot_correlations(subjects_eeg, subjects_fnirs, delay_time, num_shifts, title_suffix):
    ...
    for subject_eeg in subjects_eeg:
        for ind in subject_eeg:
            if ind.ndim == 3:
                ...
                print("This is the shape of mean_chann", mean_chann.shape)
    ...
    for subject_fnirs in subjects_fnirs:   
        for delay_fnirs in subject_fnirs:
            if delay_fnirs.ndim == 3:
                ...
                print("This is the shape of mean_chann_HBO", mean_chann_hbo.shape)
...
compute_and_plot_correlations(hc_subj_shifted_EEG_arrays, hc_subj_reduced_fnirs_arrays, delay_time, num_shifts, "Healthy Controls")

# Compute and plot correlations for patients
compute_and_plot_correlations(p_subj_shifted_EEG_arrays, p_subj_reduced_fnirs_arrays, delay_time, num_shifts, "Patients")