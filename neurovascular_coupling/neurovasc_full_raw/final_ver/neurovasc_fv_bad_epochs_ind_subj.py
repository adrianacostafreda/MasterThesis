...
def compute_and_plot_correlations(subjects_eeg, subjects_fnirs, title_suffix):
...
compute_and_plot_correlations(hc_subj_shifted_EEG_arrays, hc_subj_reduced_fnirs_arrays, "Healthy Controls")

# Compute and plot correlations for patients
compute_and_plot_correlations(p_subj_shifted_EEG_arrays, p_subj_reduced_fnirs_arrays, "Patients")