...
def epochs_from_raw(raw, raw_0back, raw_1back, raw_2back, raw_3back):
    ...
    events_0back = mne.make_fixed_length_events(raw_0back, start = 18, stop = 48, duration = 1)
    events_1back = mne.make_fixed_length_events(raw_1back, start = 18, stop = 60, duration = 1)
    events_2back = mne.make_fixed_length_events(raw_2back, start = 18, stop = 60, duration = 1)
    events_3back = mne.make_fixed_length_events(raw_3back, start = 18, stop = 60, duration = 1)
...
clean_path_0back = "H:\\Dokumenter\\data_processing\\Results_fNIRS\\patients\\coupling_8\\0_back\\"
clean_path_1back = "H:\\Dokumenter\\data_processing\\Results_fNIRS\\patients\\coupling_8\\1_back\\"
clean_path_2back = "H:\\Dokumenter\\data_processing\\Results_fNIRS\\patients\\coupling_8\\2_back\\"
clean_path_3back = "H:\\Dokumenter\\data_processing\\Results_fNIRS\\patients\\coupling_8\\3_back\\"
